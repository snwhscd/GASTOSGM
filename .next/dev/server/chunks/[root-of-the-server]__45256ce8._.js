...
"[project]/Documents/GASTOSGM/app/api/gastos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (vehiculoId) {
            ...
            const vehiculo = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].vehiculo.findUnique({
                where: {
            ...
            gastos = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].gasto.findMany({
                include: {
                    Vehiculo: {
                        select: {
                            id: true,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(gastos);
    } catch (error) {
...
async function POST(request) {
    ...
    try {
        ...
        const { folio, fecha, rz, banco, tdc, proveedor, concepto, referencia, documento, proyecto, placa, responsable, transferencia, tipoGasto } = body;
        ...
        const gasto = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].gasto.create({
            data: dataToCreate,
            include: {
                Vehiculo: {
                    select: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(gasto, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45256ce8._.js.map