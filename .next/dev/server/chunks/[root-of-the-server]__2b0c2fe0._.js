...
"[project]/Documents/GASTOSGM/app/api/vehiculos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const vehiculos = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].vehiculo.findMany({
            orderBy: {
                id: "asc"
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(vehiculos);
    } catch (error) {
...
async function POST(request) {
    ...
    try {
        ...
        const { marca, tipo, color, modelo, placas, ubicacion, motor, serie, eco, contrato, estatus, agencia, proyecto } = body;
        ...
        try {
            const existingPlacas = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].vehiculo.findUnique({
                where: {
                    placas
                }
            });
        ...
        try {
            const existingSerie = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].vehiculo.findUnique({
                where: {
                    serie
                }
            });
        ...
        try {
            const vehiculo = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].vehiculo.create({
                data: dataToCreate
            });
            console.log("Vehículo creado exitosamente:", vehiculo);
            return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(vehiculo, {
                status: 201
            });
        } catch (createError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b0c2fe0._.js.map