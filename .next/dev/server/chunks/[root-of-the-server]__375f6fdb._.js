...
"[project]/Documents/GASTOSGM/app/api/gastos-externos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const gastosExternos = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].gastoExterno.findMany({
        orderBy: {
            fecha: "asc"
        }
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(gastosExternos);
}
async function POST(req) {
    try {
        const request = await req.json();
        const data = request;
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].gastoExterno.create({
            data
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GASTOSGM$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(result);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__375f6fdb._.js.map